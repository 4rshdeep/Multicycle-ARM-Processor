...
set rc [catch {
  ...
  add_files -quiet /media/ad/Area51/workspace/assignments/col216/assignments/arm_processor/lab4_vivado/lab4_vivado.runs/synth_1/shifter.dcp
  link_design -top shifter -part xc7a35tcpg236-1
  write_hwdef -file shifter.hwdef
